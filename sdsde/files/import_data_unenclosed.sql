copy into INSERT_TABLE_NAME_HERE
 ...
 file_format = (type = csv field_delimiter = 'INSERT_DELIMITER_HERE' FIELD_OPTIONALLY_ENCLOSED_BY = '"' ESCAPE_UNENCLOSED_FIELD = INSERT_ESCAPE_UNENCLOSED_FIELD_HERE encoding = 'INSERT_ENCODING_HERE' skip_header = 1)
 on_error = continue;
